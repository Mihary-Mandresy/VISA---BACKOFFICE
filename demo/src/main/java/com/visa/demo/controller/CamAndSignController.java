...
import com.visa.demo.models.Information;
...
public class CamAndSignController {
    ...
    @PostMapping("/{id}")
    public String savePhotoAndSign(@PathVariable("id") String id, @RequestParam Map<String, MultipartFile> files,
                ...
                try {
                    ...
                    if (name.equals("photo")) {
                        ...
                        if (data == null || data.length == 0) {
                            throw new Exception("veuillez prendre une photo");
                        }
                        ...
                        if (data == null || data.length == 0) {
                            throw new Exception("veuillez mettre votre signature");
                        }

                        info.setSignature(data);
                    }
