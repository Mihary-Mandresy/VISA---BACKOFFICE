    ...
    $(".demandeurs").on("change", function () {
        ...
        if (demandeurSelected == "") {
            ...
            $.get(`/demande/api/demandeur?id=${demandeurSelected}`).then(function (response) {
                ...
                const inputIdPassport = $('<input>', {
                    type: 'hidden',
                    value: demandeurAPI.passport.id,
                    name: 'passport.id'
                })
                form.append(inputIdPassport)
                ...
                const inputIdVisaTransformable = $('<input>', {
                    type: 'hidden',
                    value: demandeurAPI.visatransformable.id,
                    name: 'visatransformable.id'
                })
                form.append(inputIdVisaTransformable)
